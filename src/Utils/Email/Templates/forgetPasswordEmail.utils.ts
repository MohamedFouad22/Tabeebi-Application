...
<div class="wrapper">
  <div class="container">
    ...
    <div class="body">
      ...
      <p class="description">
        We received a request to reset the password for your <strong>Tabeebi</strong> account. Use the authorization code below to proceed with setting up a new password.
      </p>

      <div class="otp-wrapper">
        <div class="otp-label">Reset Password Code</div>
      ...
      <div class="info-card">
        <p>
          <strong>Security Notice:</strong> If you did not request a password reset, please ignore this email or secure your account immediately. Never share this code with anyone.
        </p>
      </div>
