...
<div class="wrapper">
  <div class="container">
    ...
    <div class="body">
      ...
      <p class="description">
        Thank you for choosing <strong>Tabeebi</strong>. To secure your medical account, complete your authentication, and access your personalized healthcare dashboard, please use the OTP code below.
      </p>
      ...
      <div class="info-card">
        <p>
          <strong>Security Note:</strong> If you did not request this code, please disregard this email. Your patient privacy and personal health records remain protected.
        </p>
      </div>
